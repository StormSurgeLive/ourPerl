...
# sub getGridBounds
#
# returns the bounding box for the grid
#
# e.g.  ($west,$east,$south,$north,$minZ,$maxZ)=$adcGrid->getGridBounds();
#
###############################################################################
sub getGridBounds{
   my $obj=shift;
   return ($obj->{MIN_X},$obj->{MAX_X},$obj->{MIN_Y},$obj->{MAX_Y},$obj->{MIN_Z},$obj->{MAX_Z});
}
