...
my @REMOTEDIRS=('J:\NACCS_USACE_Data\Simulations\ET_HIS_Base',
 ...
 my $tarFileId='CME_Outputs';  # tar files matching this will be used

# my $dataName='SURGE';            # STWAVE data name (e.g. Wind, Surge, Wave)
# my $cbarTitle="Water Surface Elevation (ft-LMSL)";
 my $dataName='WAVE';            # STWAVE data name (e.g. Wind, Surge, Wave)
 my $cbarTitle="Significant Wave Height (ft)";
 ...
 my $multAdjust= 3.2808333; #meters to feet           # multiplied by magnitude (first field) (e.g. for unit conversion)    
